...
- [wiki/topics/steady-state-tropical-cyclones.md](topics/steady-state-tropical-cyclones.md)
...
Notes:
- The current wiki is review-seeded and still lacks direct ingestion of the primary studies cited by the review.
- No storm, basin, or dataset pages were created because the source is not organized around a single sample or case set.

## [2026-04-05] refine | montgomery-smith-2017-referenced-papers

Added a curated `Referenced Papers` section to [wiki/papers/montgomery-smith-2017-fluid-dynamics-of-tropical-cyclones.md](papers/montgomery-smith-2017-fluid-dynamics-of-tropical-cyclones.md) to track the highest-value cited papers for future ingestion.

Notes:
- The section is intentionally selective and is not a full bibliography dump.
- The `tc-wiki` skill was updated to preserve this convention for future review-article ingests.

## [2026-04-05] ingest | smith-montgomery-2010-hurricane-boundary-layer-theory

Ingested Smith and Montgomery (2010), a peer-reviewed primary theoretical paper on hurricane boundary-layer definition and the distinction between steady and time-dependent boundary-layer influence.
