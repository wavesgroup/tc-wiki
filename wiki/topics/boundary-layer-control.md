...
[Zhang et al. (2011)](../papers/zhang-et-al-2011-characteristic-height-scales-hurricane-boundary-layer.md) add direct dropsonde-based structure constraints. Their analysis indicates that the dynamically active inflow/agradient layer and the thermodynamic mixed layer are distinct depth scales, with eyewall-feeding inflow extending substantially above the shallow mixed layer. This observational separation supports the argument that boundary-layer control should be defined dynamically rather than by a single thermodynamic layer depth.

[Zhang et al. (2023)](../papers/zhang-et-al-2023-mean-kinematic-structure-tc-boundary-layer-intensity-change.md) extend the dropsonde evidence base by conditioning boundary-layer kinematic structure on intensity tendency, reporting systematic differences between strengthening and non-strengthening storms. This supports using boundary-layer flow structure as an intensity-change-relevant diagnostic rather than only a static structural descriptor.
