...
This cold-wake branch complements the existing high-wind exchange branch from [Powell et al. (2003)](../papers/powell-vickery-reinhold-2003-reduced-drag-coefficient-high-wind-speeds.md), [Donelan et al. (2004)](../papers/donelan-et-al-2004-limiting-aerodynamic-roughness-ocean-very-strong-winds.md), [Holthuijsen et al. (2012)](../papers/holthuijsen-powell-pietrzak-2012-wind-and-waves-in-extreme-hurricanes.md), and [Curcic and Haus (2020)](../papers/curcic-haus-2020-revised-estimates-ocean-surface-drag-strong-winds.md), which constrain how momentum exchange behaves at extreme wind speeds.

The new CBLAST ingest sharpens that exchange branch with direct field constraints on both momentum and enthalpy transfer. [French et al. (2007)](../papers/french-drennan-zhang-black-2007-hurricane-boundary-layer-momentum-flux.md) provide the first direct hurricane-boundary-layer momentum-flux measurements and suggest drag roll-off between about 18 and 30 m s^-1. [Drennan et al. (2007)](../papers/drennan-et-al-2007-hurricane-boundary-layer-latent-heat-flux.md) report no significant increase in the Dalton number up to 30 m s^-1. [Zhang et al. (2008)](../papers/zhang-black-french-drennan-2008-direct-enthalpy-flux-cblast.md) then add direct enthalpy-flux measurements and report a mean `CK/CD` below earlier development-threshold estimates. [Black et al. (2007)](../papers/black-et-al-2007-air-sea-exchange-cblast.md) synthesize these results, argue that roll vortices may augment boundary-layer exchange, and place them alongside simultaneous wave and upper-ocean observations. [Bell et al. (2012)](../papers/bell-montgomery-emanuel-2012-major-hurricane-exchange-coefficients-cblast.md) extend the branch into the major-hurricane regime and still do not find significant `CK/CD` growth above 50 m s^-1. Inference for this wiki: intensity prediction errors can arise both from under-resolved ocean cooling and from overly simple expectations about how strong-wind enthalpy and momentum exchange behave.
...
- [French et al. (2007)](../papers/french-drennan-zhang-black-2007-hurricane-boundary-layer-momentum-flux.md) provide the first direct momentum-flux measurements in hurricane boundary layers and report a likely drag roll-off signal.
...
- [Zhang et al. (2008)](../papers/zhang-black-french-drennan-2008-direct-enthalpy-flux-cblast.md) provide the first direct enthalpy-flux measurements in the hurricane boundary layer and report a mean `CK/CD` below earlier threshold estimates.
- [Black et al. (2007)](../papers/black-et-al-2007-air-sea-exchange-cblast.md) synthesize the direct CBLAST results and link the exchange-coefficient problem to roll vortices, waves, and upper-ocean response.
